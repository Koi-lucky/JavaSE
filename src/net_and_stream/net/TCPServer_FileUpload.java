...
/**
 * 【文件上传案例—— 服务器端】：读取客户端上传的文件，保存到服务器的硬盘，给客户端回写数据“上传成功”
 *
 * 明确：
 *      数据源：客户端上传的文件
 ...
 *      4.判断文件夹是否存在，不存在则创建
 *      5.创建一个本地的字节输出流FileOutputStream对象，构造方法中绑定要读取的数据源
 ...
 *      9.使用网络字节输出流OutputStream对象中的方法write，给客户端回写数据“数据上传成功”
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            /*
                ...
                规则：域名+毫秒值+随机数
             */
                        String filename = "计算机" + System.currentTimeMillis() + new Random().nextInt(999999) + ".jpg";
                        //5.创建一个本地的字节输出流FileOutputStream对象，构造方法中绑定要读取的数据源
